...
#ifndef EVAL_TOPOLOGY_BULK_H
#define EVAL_TOPOLOGY_BULK_H
...
public:
   ...
   */
  EvaluationTopologyBulk (std::string ScenarioName,
                      uint32_t numFlows,
...
private:
  ...
  std::vector < Ptr < EvalBulkApp >> m_sources;       //!< List of application sources
